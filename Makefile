...
mintMood:
	@forge script script/DeployMoodNftMinting.s.sol:DeployMoodNftMinting $(NETWORK_ARGS)

flipMood:
	@forge script script/DeployMoodNftFlippingMood.s.sol:DeployMoodNftFlippingMood $(NETWORK_ARGS)